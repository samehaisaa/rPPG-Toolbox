...
_C.UNSUPERVISED.CHROM_PERTURBATIONS.SAVE_PERTURBED_VIDEOS = False
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.SAVE_PATH = ''
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PERTURBATION_TYPES = []
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.GAUSSIAN_NOISE = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.GAUSSIAN_NOISE.NOISE_STD_FRACTION = 0.01
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.BLUR = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.BLUR.KERNEL_SIZE = 3
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.BRIGHTNESS = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.BRIGHTNESS.BRIGHTNESS_FACTOR = 0.1
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.CROP = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.CROP.CROP_FRACTION = 0.1
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.ROTATION = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.ROTATION.ANGLE_RANGE = 5
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.COLOR_JITTER = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.COLOR_JITTER.FACTOR = 0.1
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.COMPRESSION = CN()
_C.UNSUPERVISED.CHROM_PERTURBATIONS.PARAMS.COMPRESSION.QUALITY = 90
